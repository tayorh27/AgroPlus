...
import com.ap.agroplus.network.VerifyAccessCode;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public void UpdatePassword(View view) {
        ...
        String access_code = "AP" + _username.substring(0, 1) + _email.substring(0, 1) + new Random().nextInt(9000);
        ...
        UpdateUser updateUser = new UpdateUser(ChangePasswordActivity.this, _email, password2, access_code);
        updateUser.UpdateUser(ChangePasswordActivity.this);
    }
